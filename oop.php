...
<?php
echo "<h1>OOP - Object Oriented Programming</h1><br>";
class User
{
    public $name;
    public $email;
...
$user1 = new User("Trang Đặng", "trang071199@gmail.com", 23, "aye");
$employee1 = new Employee("Trang Đặng", "trang071199@gmail.com", 23, "aye","Manager");
print_r($user1);
print_r($employee1);
